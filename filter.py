...
def filter_names():
    ...
    input_file = open('C:/Users/pomer/Documents/Rush/pipy-scraper/nameslists/{}.txt'.format(username), 'r')


    try:
        output_file = open('C:/Users/pomer/Documents/Rush/pipy-scraper/filtered/{}.txt'.format(username), 'x')
        output_file.close()
        output_file = open('C:/Users/pomer/Documents/Rush/pipy-scraper/filtered/{}.txt'.format(username), 'w')
